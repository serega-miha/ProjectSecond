...
/* harmony import */ var _modules_valid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/valid */ "./src/js/modules/valid.js");
...
/* harmony import */ var _modules_lookMoreStyles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/lookMoreStyles */ "./src/js/modules/lookMoreStyles.js");
...
/* harmony import */ var _modules_enterChange__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/enterChange */ "./src/js/modules/enterChange.js");
...
/* harmony import */ var _modules_scroll__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/scroll */ "./src/js/modules/scroll.js");
 ...
 //npm i imask библиотека для номеров телефонов в формах
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_valid__WEBPACK_IMPORTED_MODULE_3__["default"])();
  ...
  Object(_modules_lookMoreStyles__WEBPACK_IMPORTED_MODULE_6__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(_modules_enterChange__WEBPACK_IMPORTED_MODULE_9__["default"])();
...
/* harmony default export */ __webpack_exports__["default"] = (enterChange);
...
/* harmony default export */ __webpack_exports__["default"] = (formsSend);

/***/ }),

/***/ "./src/js/modules/lookMoreStyles.js":
/*!******************************************!*\
  !*** ./src/js/modules/lookMoreStyles.js ***!
  \******************************************/
/*! exports provided: default */
...
const lookMoreStyle = (trigger, wrapper) => {
  ...
  btnLookMoreStyle.addEventListener('click', function () {
    //поставили функцию вместо стрелочной функции, т.к. стрелочная не имеет в контексте вызова сам объект вызова, а функция безымяная имеет
...
/* harmony default export */ __webpack_exports__["default"] = (lookMoreStyle);
...
const scroll = () => {
  ...
  links.forEach(item => {
    if (item.href.split('#')[1] > '') {
      ...
      item.addEventListener('click', e => {
        e.preventDefault();
        document.querySelector(`#${toLink}`).scrollIntoView({
          behavior: "smooth"
        });
      });
    }
